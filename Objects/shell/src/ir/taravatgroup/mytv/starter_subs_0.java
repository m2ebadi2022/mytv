...
if (RapidSub.canDelegate("application_error")) { return ir.taravatgroup.mytv.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("service_create")) { return ir.taravatgroup.mytv.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return ir.taravatgroup.mytv.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return ir.taravatgroup.mytv.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return ir.taravatgroup.mytv.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
